...
struct ContentView: View {
    ...
    @State private var editingItem: CoverEvent?
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Car Cover Reminder")
            .toolbar {
    ...
    private func editSheet(for item: CoverEvent) -> some View {
...
struct EditItemView: View {
    ...
    @State var item: CoverEvent
    var onSave: (CoverEvent) -> Void
    var onDelete: () -> Void
